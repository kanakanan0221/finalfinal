...
//                         ofDisableDepthTest();
                          ...
                          ofSetColor(255);
                            ...
                            ofSetColor(255);
                            neko.draw(n, a, neko.getWidth()*1.5, neko.getHeight()*1.5);
                        ...
                        cout << "manbo-x:"<<fingerPos.at(7).x<<endl;
                        cout << "manbo-y:"<<fingerPos.at(7).y<<endl;
